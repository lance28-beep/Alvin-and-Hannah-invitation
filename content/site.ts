export const siteConfig = {
  couple: {
    bride: "Hannah Shane Blas",
    brideNickname: "Hannah",
    groom: "Alvin Gallie Lopez",
    groomNickname: "Alvin",
  },
  wedding: {
    date: "MARCH 26, 2026",
  ...
  ceremony: {
    location: "Holy Rosary Parish Church Angeles Pampanga",
    venue: "Holy Rosary Parish Church Angeles Pampanga",
    date: "March 26 2026",
    day: "Thursday",
    time: "2:30 PM",
...
Now, as they prepare to say yes before God and the people they love most, Catherine is grateful for the patience, humor, and hope Mark brings to every day. She knows this next chapter is just the start of the love story they get to write together.`,
  ...
  snapShare: {
    googleDriveLink: "https://drive.google.com/drive/folders/17wy8sLyQgw-5CFjWnUnGUXoav9DZ8SNE?usp=sharing",
    hashtag: "#AlvinAndHannah",
